...
const lightThemeColors: ThemeProperties = {
    background: '#ffef33',
    backgroundERC721: '#ffef33',
    borderColor: '#dedede',
    boxShadow: '0 10px 10px rgba(0, 0, 0, 0.1)',
    buttonBuyBackgroundColor: '#3CB34F',
    buttonCollectibleSellBackgroundColor: '#000',
    ...
    buttonQuaternaryBackgroundColor: '#000',
    ...
    marketsSearchFieldBackgroundColor: '#ffef33',
    marketsSearchFieldBorderColor: '#dedede',
    marketsSearchFieldTextColor: '#333',
    modalSearchFieldBackgroundColor: '#ffef33',
    modalSearchFieldBorderColor: '#fff',
    modalSearchFieldPlaceholderColor: '#ffef33',
